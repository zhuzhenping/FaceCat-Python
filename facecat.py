...
def invalidate(paint):
	...
	for view in paint.m_views:
		if view.m_dock == "fill":
			view.m_size = FCSize(paint.m_size.cx, paint.m_size.cy)
	updateView(paint.m_views)
...
m_paintCallBack = onViewPaint 
m_paintBorderCallBack = onViewPaintBorder 
m_mouseDownCallBack = onViewMouseDown 
m_mouseMoveCallBack = onViewMouseMove 
m_mouseUpCallBack = onViewMouseUp
m_mouseWheelCallBack = onViewMouseWheel
m_clickCallBack = onViewClick
